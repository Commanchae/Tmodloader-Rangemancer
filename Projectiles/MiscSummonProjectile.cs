...
{
    public abstract class MiscSummonProjectile : ModProjectile
    {
        ...
        protected Item itemDefault = new Item();
            ...
            if (foundTarget)
            {
                ...
                if (shootCounter >= shootCooldown)
                {
                    ...
                    if (Main.myPlayer == Projectile.owner)
                    {
                        ...
                        Item chosenAmmo = Main.player[Projectile.owner].ChooseAmmo(itemDefault);
