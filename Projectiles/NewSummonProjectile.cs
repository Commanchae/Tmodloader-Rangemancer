...
{
    public abstract class NewSummonProjectile : ModProjectile
    {
        ...
        protected float searchDistance = 700f;
        ...
        private void GeneralBehavior(Player owner, out Vector2 vectorToIdlePosition, out float distanceToIdlePosition)
        {
            ...
            float circleRadius = 100f; // Adjust this value to control the radius of the circle
            int activeMinions = 0; // Track the number of active minions
            int myIndex = -1;
            ...
            float angleIncrement = MathHelper.TwoPi / activeMinions; // Calculate the angle between each minion
            Vector2 offset = new Vector2(circleRadius, 0f).RotatedBy(myIndex*angleIncrement);
